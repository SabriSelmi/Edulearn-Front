...
import Humanities from './humanitiesitem';
const axios = require('axios');

class Humanitiescourse extends Component{
    constructor(props){
        super(props)
        this.state={
          nom:'',
    ...
    handleClick = (event) => {
      ...
      componentDidMount =()=>{
        axios.get('/Humanitiescourse').then(res=>
          this.setState({
    ...
    <li class="page-item"><a   key={number}
     ...
     <div>
                 ...
                 {currentTodos.map((el,i)=><Humanities course ={el}  key={i}/>)}
...
export default Humanitiescourse;
